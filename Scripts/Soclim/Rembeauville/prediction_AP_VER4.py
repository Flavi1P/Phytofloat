...
for f in np.arange(len(floats)): #For each float
	print f
#Open the data
	datadir = '/home/admt/PROGRAM_AP/CODE_REMBAUVILLLE/data/'+floats+'/'
...
#	chl[f] = chl[f] *  0.24
	print floats, 'F490=',np.nanmedian(F_all[f])
...
#	print T
	...
	numpy.savetxt('/home/admt/PROGRAM_AP/CODE_REMBAUVILLLE/DATA_TEXT_OUT/time'+floats+'.txt', T, delimiter=",")
	numpy.savetxt('/home/admt/PROGRAM_AP/CODE_REMBAUVILLLE/DATA_TEXT_OUT/depth'+floats+'.txt', depth, delimiter=",")
		
	numpy.savetxt('/home/admt/PROGRAM_AP/CODE_REMBAUVILLLE/DATA_TEXT_OUT/chl'+floats+'.txt', chl, delimiter=",")
	numpy.savetxt('/home/admt/PROGRAM_AP/CODE_REMBAUVILLLE/DATA_TEXT_OUT/bbp'+floats+'.txt', bbp, delimiter=",")
	numpy.savetxt('/home/admt/PROGRAM_AP/CODE_REMBAUVILLLE/DATA_TEXT_OUT/cp'+floats+'.txt', cp, delimiter=",")

	numpy.savetxt('/home/admt/PROGRAM_AP/CODE_REMBAUVILLLE/DATA_TEXT_OUT/bact'+floats+'.txt',bact[f], delimiter=",")

	numpy.savetxt('/home/admt/PROGRAM_AP/CODE_REMBAUVILLLE/DATA_TEXT_OUT/pico'+floats+'.txt',pico[f], delimiter=",")
	numpy.savetxt('/home/admt/PROGRAM_AP/CODE_REMBAUVILLLE/DATA_TEXT_OUT/nano'+floats+'.txt',nano[f], delimiter=",")
	numpy.savetxt('/home/admt/PROGRAM_AP/CODE_REMBAUVILLLE/DATA_TEXT_OUT/diat'+floats+'.txt',diat[f], delimiter=",")
